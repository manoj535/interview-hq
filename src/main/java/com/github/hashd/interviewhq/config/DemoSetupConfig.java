...
/**
 * Created by kd on 3/6/15.
 */
@Configuration
public class DemoSetupConfig {

  @Bean
  InitializingBean populateTestData(QuestionTagRepository questionTagRepository, UserRoleRepository userRoleRepository, PasswordEncoder passwordEncoder) {
    return () -> {
